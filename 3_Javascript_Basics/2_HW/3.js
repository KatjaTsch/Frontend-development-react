...
// {
//     if(dayNumberNum <= 10){
//         console.log(prompt((`Число ${dayNumberNum} попадает в 1 декаду месяца.`)));
//     } else(dayNumberNum >= 10 && dayNumberNum <=20)
//         console.log(prompt((`Число ${dayNumberNum} попадает вo 2 декаду месяца.`)));
//     }
//     else{
//         console.log(prompt((`Число ${dayNumberNum} попадает в 3 декаду месяца.`)));
//     }
// //   console.log(prompt((`Число ${dayNumberNum} попадает в ${dayNumberNum/10 +1} декаду месяца.`)));
// //  else {
// //   console.log(`Неверное значение`);
// // }
